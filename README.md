...
```
In addition to Piccolo, to use Seurat you'll need to install Seurat from CRAN (currently Piccolo has been set up for use with Seurat v4 and not the latest development version v5):
```
